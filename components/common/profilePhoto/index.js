...
// }
  ...
  >
    <h2>更換大頭貼</h2>
    <p>選擇您想要進行的操作：</p>
    <div><button onClick={handleImageClick}>上傳大頭貼</button></div>
    <div><button onClick={handleRemoveImage}>移除大頭貼</button></div>
    <div><button onClick={handleModalClose}>取消</button></div>
